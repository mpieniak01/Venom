  ...
  return (
    <aside className="glass-panel fixed inset-y-0 left-0 z-40 hidden w-64 flex-col border-r border-white/5 bg-black/20 px-5 py-6 text-zinc-100 shadow-neon lg:flex">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-zinc-400">Venom</p>
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <Link
                href={item.href}
                className="flex w-full items-center gap-3 rounded-xl px-3 py-2 text-sm font-medium text-inherit"
              >
      ...
      <div className="mt-auto space-y-4">
        ...
        <section
          className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-zinc-100"
