...
"""
        ...
        assert "@kernel_function" in tool_code, "Kod nie zawiera dekoratora @kernel_function"
        ...
        print(f"✅ Test The Forge zakończony sukcesem!")
...
"""
        ...
        print(f"✅ Calculator skill utworzony i załadowany!")
