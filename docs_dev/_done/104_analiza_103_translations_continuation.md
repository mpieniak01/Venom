...
### 2026-02-02 (i18n: Cockpit chat)
- Ujednolicono tłumaczenia w głównym czacie Cockpitu:
  - Label użytkownika: `Operacja` → `Użytkownik` (PL) + odpowiedniki EN/DE.
  - Link `Szczegóły ↗` oraz komunikaty `Wysłano zadanie: ...` i stan „w toku…” przepisane na klucze i18n.
  - Dodatkowo: fallbacki „Brak treści”, „Wynik obliczeń”, tooltipy „Użyto lekcji/pamięci” również przeniesione do i18n.
