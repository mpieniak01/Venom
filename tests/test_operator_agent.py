...
class TestOperatorAgent:
    ...
    def test_initialization_with_hardware_bridge(self, mock_kernel, mock_hardware_bridge):
    ...
    async def test_is_hardware_command_false(self, mock_kernel):
        ...
        assert await agent._is_hardware_command("jaki jest status repozytorium?") is False
    ...
    @pytest.mark.asyncio
    async def test_handle_hardware_command_status(self, mock_kernel, mock_hardware_bridge):
    ...
    @pytest.mark.asyncio
    async def test_handle_hardware_command_temperature(self, mock_kernel, mock_hardware_bridge):
    ...
    @pytest.mark.asyncio
    async def test_handle_hardware_command_gpio_on(self, mock_kernel, mock_hardware_bridge):
    ...
    @pytest.mark.asyncio
    async def test_handle_hardware_command_gpio_off(self, mock_kernel, mock_hardware_bridge):
    ...
    @pytest.mark.asyncio
    async def test_handle_hardware_command_emergency(self, mock_kernel, mock_hardware_bridge):
