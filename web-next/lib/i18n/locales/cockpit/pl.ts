export const cockpitLocale = {
    ...
    requestDetails: {
      ...
      modelLabel: "Model",
      runtimeExecutionModelLabel: "Model wykonawczy runtime",
      selectedBaseModelLabel: "Wybrany model bazowy",
      ...
      runtimeFlowOnnxNote:
        "Requesty ONNX mogą iść dedykowaną ścieżką taskową (OnnxTask), dlatego diagram diagnostyczny może być krótszy niż dla Ollama.",
    ...
    models: {
      ...
      activeRuntimeModelLabel: "Aktywny model runtime",
      selectedBaseModelLabel: "Wybrany model bazowy",
      ...
      adapterRuntimeOffline:
        "runtime {{runtime}} jest offline - uruchom runtime przed deployem adaptera do czatu",
