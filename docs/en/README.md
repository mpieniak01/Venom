...
**We already use ONNX:** currently in perception layer (vision) — OCR/object recognition — via local ONNX Runtime models. LLMs remain on Ollama/vLLM (or cloud), and ONNX covers the vision scope.
