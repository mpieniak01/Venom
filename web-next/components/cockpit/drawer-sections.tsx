...
export function PromptSection({ prompt, t }: { prompt: string; t: any }) {
    return (
...
export function ModelInfoSection({ historyDetail, t }: { historyDetail: HistoryRequestDetail; t: any }) {
...
export function LogsSection({ logs, t }: { logs: string[]; t: any }) {
