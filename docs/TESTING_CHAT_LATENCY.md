...
| 2026-02-26 | `tests/perf/test_llm_simple_e2e.py` + `tests/perf/test_llm_latency_e2e.py` + `tests/perf/test_latency_modes_e2e.py` (`onnx`/`ollama`/`vllm`, Gemma3 variants) | PASS; details: `docs/_to_do/175_onnx_gemma3_latency_diagnostics_2026_02_26.md` |
