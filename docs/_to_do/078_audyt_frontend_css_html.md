...
## Zakres
- Frontend: `web`, `web-next` (CSS/HTML/JS/TS pod katem layoutu i stylow).
...
4) Lista rekomendacji: standaryzacja stylow, podzial CSS, ewentualne usuniecie reliktow.
...
## Format raportu (frontend CSS/HTML)
Plik raportu: `docs/_done/078_audyt_frontend_css_html_report.md`
...
- `Propozycje standaryzacji` (tokeny, klasy bazowe, minimalny podzial).
