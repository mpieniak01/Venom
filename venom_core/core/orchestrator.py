...
Odpowiedz APPROVED jeśli wygląda OK, lub opisz problemy."""
    ...
    async def handle_remote_issue(self, issue_number: int) -> dict:
        ...
        """
        try:
            logger.info(f"🚀 Rozpoczynam workflow Issue-to-PR dla Issue #{issue_number}")
...
{plan_result}"""
            ...
            pr_body = f"Automatyczna naprawa Issue #{issue_number}\n\n{fix_result[:500]}"
            ...
            return {"success": False, "issue_number": issue_number, "message": error_msg}
