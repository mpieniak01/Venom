...
class WorkflowStateMachine:
    ...
    @classmethod
    def get_allowed_transitions(cls, from_state: WorkflowStatus) -> list[WorkflowStatus]:
...
class WorkflowOperationService:
    ...
    def dry_run(
        ...
        # Dry-run doesn't change state, just simulates
        self._audit_trail.log_operation(
            triggered_by=triggered_by,
        ...
        logger.info(f"Dry-run executed for workflow {workflow_id} by {triggered_by}")
