...
- **Voice output** – engine-aware TTS selector shared with `/voice` and the cockpit, with Piper as the stable default and Fish Speech shown as an explicit alternative when available.
