...
class MockEvolutionCoordinator:
    ...
    def _create_shadow_instance(self, branch_name: str, project_root: Path) -> InstanceInfo:
...
@pytest.fixture
def evolution_coordinator(mock_system_engineer, mock_mirror_world, mock_core_skill, mock_git_skill):
