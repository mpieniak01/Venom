...
PROBE_MAX_PROMPT_TOKENS="$(env_contract_get GEMMA4_AUDIO_PROBE_MAX_PROMPT_TOKENS "1024" "$ENV_FILE")"
PROBE_MAX_LAYERS="$(env_contract_get GEMMA4_AUDIO_PROBE_MAX_LAYERS "8" "$ENV_FILE")"
PROBE_MAX_TOP_K="$(env_contract_get GEMMA4_AUDIO_PROBE_MAX_TOP_K "32" "$ENV_FILE")"
PROBE_HIDDEN_SLICE="$(env_contract_get GEMMA4_AUDIO_PROBE_HIDDEN_SLICE "16" "$ENV_FILE")"
